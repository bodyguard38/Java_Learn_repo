...
public class C02_Arac {  //class level
    ...
    public static void main(String[] args) {//main level
        ...
        arc1.motorHacim=2.0;
        arc1.yil = 2015;
        // System.out.println("arc1 = " + arc1);// arc1 = J20_Constructor.C02_Arac@6cd8737 ref data
        System.out.println("arc1 -->  " + arc1);
        System.out.println(arc1.marka + ", " + arc1.model + ", " + arc1.km + ", " + arc1.yil + ", "
                + arc1.motorHacim + ", " + arc1.automatic+", "+arc1.ikinciEl);
    ...
    @Override
public String toString() {//bu meth datalari string econvert eder.
return
        "marka="+marka+'\''+"model='"+model+'\''+"km="+km+'\''+"motorHacim="+motorHacim+'\''
                +"automatic="+automatic+'\''+"ikinciEl="+ikinciEl+'\''+"yil="+yil;
