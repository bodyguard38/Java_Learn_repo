...
public class C01_Ogretmen {/*
    ...
    */
    String isim;//ins obje variable
    int tecrube;//ins obje variable
    static String okul;//her obje icin sabit olan class variable

    public C01_Ogretmen(String isim, int tecrube) {//full p'li telescopic const.
        this.isim = isim;
        this.tecrube = tecrube;
    }
    public static void maasHesapla(){    //static method
        System.out.println("Agam maasin helali hos olsun yemeye devam");
    }
    public void evlilikYilDonumu(){// non static method
        System.out.println("Agam yengenin kiymetini iyi bilesen...");
    }
}
