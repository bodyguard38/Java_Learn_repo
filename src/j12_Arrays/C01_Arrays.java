...
public class C01_Arrays {
    public static void main(String[] args) {
        ...
        sayiArr[1] = 25;//sayiArr 1. index 25 value atandı
        sayiArr[0] = 46;//sayiArr 0. index 46 value atandı
        sayiArr[2] = 31;//sayiArr 2. index 31 value atandı
        sayiArr[1] = 2;//sayiArr 1. index 2 value update-> array elemanları unique olmak zorunda değil tekrarlı eleman barındırabilir
        sayiArr[3] = 2;
        sayiArr[4] = 46;
