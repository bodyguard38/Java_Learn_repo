...
public class C01_Encapsulation {
    ...
    */
     public static void main(String[] args) {
         ...
         obj1.setId(9999);//obj ile set method call edilerek id private variable 9999 ile update edildi
         System.out.println("obj1.getId() = " + obj1.getId());


         obj1.soyAdi="basarili";//encapsulated edilmeyen variable obj ile erisilip update edilebilir.
         // buvariable icin istenmeyen durum olabilir
     }
